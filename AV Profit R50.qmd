...
# tav_equals_tomato_r50[which.max(tav_equals_tomato_r50$tav_profit),]
# cat("Minimum REAP Compensation to make TAV as profitable as Tomato: ",
#     abs(max(tcc_tav_tomato_r50$eannprofworeap)) + 9619.38, fill = TRUE)

# tcc_tav_tomato_r50[which.min(tcc_tav_tomato_r50$eannprofworeap),]
# cat("Maximum REAP Compensation to make TAV as profitable as Tomato: ",
#     abs(min(tcc_tav_tomato_r50$eannprofworeap)) + 9619.38, fill = TRUE)
```
