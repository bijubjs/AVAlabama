...
-   Comments: Subtract annual maintenance cost and annualized CAPEX for 25 years at 5% interest rate.
...
<!-- -->
```
-   First 13 variables are from solar_profit. See "Profit from solar" for more details about variables. Next 4 variables are from tomato_long. See "profit from tomato" for more details about variables. The $18^{th}$ variable is the final profit from tomato agrivoltaic system which is the result of our interest.

```{r, echo=TRUE, results='show', include=TRUE, error=TRUE, warning=TRUE}
...
process_combination <- function(indices) {
  ...
  new_row <- c(solar_profit[i, ],
               tomato_long[j, ], 
               solar_profit[i, 13] + tomato_long[j, 4])
  return(new_row)
}
...
<!-- -->
```
-   First 13 variables are from solar_profit. See "Profit from solar" for more details about variables. Next 4 variables are from strawberry_long. See "profit from strawberry" for more details about variables. The $18^{th}$ variable is the final profit from strawberry agrivoltaic system which is the result of our interest.
...
<!-- -->
```
-   First 13 variables are from solar_profit. See "Profit from solar" for more details about variables. Next 4 variables are from squash_long. See "profit from squash" for more details about variables. The $18^{th}$ variable is the final profit from squash agrivoltaic system which is the result of our interest.
...
process_combination <- function(indices) {
  ...
  new_row <- c(solar_profit[i, ],
               squash_long[j, ], 
               solar_profit[i, 13] + squash_long[j, 4])
  return(new_row)
}
