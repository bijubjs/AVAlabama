...
tav_chtbl <- result_matrix #Table in Excel.
rm(result_matrix)
```
...
sbav_chtbl <- result_matrix #Table in Excel.
rm(result_matrix)
```
...
sqav_chtbl <- result_matrix #Table in Excel.
rm(result_matrix)
```
